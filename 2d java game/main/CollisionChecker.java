...
public class CollisionChecker {
    ...
    public void checkTile(Entity entity) {
        // Using Entity instead of just player because every entity (monsters, player, etc) will have a collision box.
    ...
    public int checkObject(Entity entity, boolean player) {
        ...
        for (int i = 0; i < gp.obj.length; i++) {
            if (gp.obj[i] != null) {
                ...
                // Get the solid area of the object.
                ...
                // Update the solid area of the object.
                ...
                switch (entity.direction) {
                    case "up":
                        ...
                        if (entity.solidArea.intersects(gp.obj[i].solidArea)) {
                            ...
                            if (player == true) {
                                index = i; // return the index of the object that was collided with.
                            }
                        }
                        break;
                    case "down":
                ...
                // Reset the solid area position to original position.
